...
final class NFATests: XCTestCase {
    ...
    func test_match1Or2_andNot1_matches2AndNot1() {
        let nfa: NFA<Int> = .only({ 1...2 ~= $0 }) & !.only({ $0 == 1 })
    ...
    func test_1Or2Or2Or3_matches1Or2Or3() {
        let nfa: NFA<Int> = .only({ 1...2 ~= $0 }) | .only({ 2...3 ~= $0 })
    ...
    func test_1then2_matches1Then2() {
        let nfa = NFA<Int>.only({ $0 == 1 }).then(.only({ $0 == 2 }))
    ...
    func test_1then2then3() {
        let nfa: NFA<Int> = NFA<Int>.only({ $0 == 1 }).then(.only({ $0 == 2 })).then(.only({ $0 == 3}))
    ...
    func test_1optional() {
        let nfa =  NFA<Int>.only({ $0 == 1 }).optional
    ...
    func test_not1optional() {
        let nfa: NFA<Int> =  !(NFA.only({ $0 == 1 }).optional)
    ...
    func test_not1star() {
        let nfa: NFA<Int> = !(NFA.only({ $0 == 1 }).star)
